...
package com.zsg.sexmusic.dialog;
...
public class CardPickerDialog extends DialogFragment implements View.OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case android.R.id.button1:
                if (mClickListener != null) {
                    mClickListener.onChangeThemeClick(mCurrentTheme);
                }
    ...
    public void setClickListener(ThemeClickListener clickListener) {
        mClickListener = clickListener;
    }

    public interface ThemeClickListener {
        void onChangeThemeClick(int currentTheme);
    }
}
